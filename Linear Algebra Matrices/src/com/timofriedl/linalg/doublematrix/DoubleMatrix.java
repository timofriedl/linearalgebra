...
public class DoubleMatrix {
  ...
  /**
   * Adds the values of a second {@link DoubleMatrix} with the same bounds to this.
   * 
  ...
  /**
   * Adds the values of a {@link DoubleVector} to a given row of this {@link DoubleMatrix}.
   * 
  ...
  /**
   * Adds the values of a {@link DoubleVector} to a given column of this {@link DoubleMatrix}.
   * 
  ...
  /**
   * Scales all numbers of a given row of this {@link DoubleMatrix} with a given factor.
   * 
  ...
  /**
   * Scales all numbers of a given column of this {@link DoubleMatrix} with a given factor.
   * 
  ...
  public void scaleColumn(int columnNr, double factor) {
    if (columnNr < 0 || columnNr >= getWidth())
      throw new IllegalArgumentException("The column " + columnNr + " cannot be scaled, it's outside of this matrix.");
  ...
  /**
   * Resizes this {@link DoubleMatrix} to a new given size, adding zeros if size increases and
  ...
  /**
   * Copies an area of this matrix to another {@link DoubleMatrix} instance, failing if the given area
  ...
  /**
   * Filles this {@link DoubleMatrix} at a given offset with the numbers of a second matrix, failing
  ...
  /**
   * Appends a second {@link DoubleMatrix} on the right of this matrix, failing if the height is
   * different.
   * 
   ...
   * @param rowNr
   */
  public DoubleMatrix removeRow(int rowNr) {
    if (rowNr < 0 || rowNr >= getHeight())
   ...
   */
  public DoubleMatrix removeColumn(int columnNr) {
    if (columnNr < 0 || columnNr >= getWidth())
  ...
  /**
   * Returns a row of this {@link DoubleMatrix} at a given row number as a {@link DoubleVector}.
   * 
  ...
  /**
   * Returns a column of this {@link DoubleMatrix} at a given column number as a {@link DoubleVector}.
   * 
